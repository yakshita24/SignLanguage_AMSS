...
# The stratify parameter ensures that the training and testing sets have approximately the same proportion of samples from each class, based on the labels array.
